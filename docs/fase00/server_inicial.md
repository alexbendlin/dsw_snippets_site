...
> Back-end Express + SQLite "cru" — base para a Fase 01 sanitizar.
...
> ⚠️ **Problemas didáticos neste código** (serão corrigidos na Fase 01):
> - `as any` na linha 28
> - Erros vazam stack trace (linhas 60, 108)
> - Validação de tipo frágil (linha 70)
> - `db.prepare` repetido dentro das rotas
> - `PORT` hardcoded
> - Sem autenticação/isolamento por usuário